export default [
  ...
  {
    question: '¿Quién se encarga de supervisar, una vez comenzada la obra?',
    answer:
      'La supervisión de la obra está a cargo del equipo técnico responsable del proyecto. Contamos con la capacidad y la experiencia necesarias para asegurar que cada etapa del proyecto se ejecute correctamente y cumpla con los estándares de calidad.',
  },
  {
    question:
      '¿El permiso de construcción garantiza que el municipio no paralice ni multe la obra ?',
    answer:
      'Contar con el permiso de construcción reduce significativamente el riesgo de que el municipio paralice o multe la obra, ya que acredita que el proyecto cumple con los requisitos legales y técnicos. Sin embargo, es importante mantener toda la documentación actualizada y ejecutar la obra conforme a lo aprobado para evitar inconvenientes.',
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      'No, nuestro asesoramiento inicial no tiene ningún costo. Estamos completamente disponibles para resolver tus dudas y brindarte la orientación que necesites sin compromiso. Si el caso requiere una visita técnica en el sitio, esta tendría un costo de 35 dólares.',
  },
];

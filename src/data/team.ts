...
const team = [
  {
    slug: 'dayana-chiguano',
    name: 'Dayana Chiguano',
    approach: 'Arquitectura sostenible',
    image: `${cdn}/equipo/dayana_chiguano.webp`,
    rol: 'Miembro fundador',
    alt: 'Miembro del equipo, Dayana Chiguano',
    education: [
      {
    ...
    socialNetworks: [
      {
        name: 'linkedin',
        url: 'https://www.linkedin.com/in/dayana-chiguano/',
      },
    ],
  },
  {
    ...
    name: 'Lizeth Narvaez',
    approach: 'Arquitectura sostenible',
    image: `${cdn}/equipo/lizeth_narvaez.webp`,
    rol: 'Miembro fundador',
    alt: 'Miembro del equipo, Lizeth Narvaez',
    education: [
      {
        degree: 'Arquitectura y  Urbanismo',
        university: 'Universidad Central del Ecuador',
  ...
  },
  {
    ...
    name: 'Tatiana Paucar',
    approach: 'Arquitectura sostenible',
    image: `${cdn}/equipo/tatiana_paucar.webp`,
    rol: 'Miembro fundador',
    alt: 'Miembro del equipo, Tatiana Paucar',
    education: [
      {
        degree: 'Arquitectura y  Urbanismo',
        university: 'Universidad Central del Ecuador',
  ...
  },
  {
    ...
    name: 'Esteban Caiza',
    approach: 'Arquitectura sostenible',
    image: `${cdn}/equipo/esteban_caiza.webp`,
    rol: 'Miembro fundador',
    alt: 'Miembro del equipo, Esteban Caiza',
    education: [
      {
        degree: 'Arquitectura y  Urbanismo',
        university: 'Universidad Central del Ecuador',
    ...
    licenceNumber: '2023-001',
    about:
      'Arquitecto graduado a inicios de 2025, con conocimientos en normativa urbana y nociones en intervención patrimonial. Cuenta con capacidad de análisis numérico y gráfico, manejo de documentación técnica y apoyo en procesos de diseño y regularización. Orientado al aprendizaje continuo y al desarrollo profesional.',
    socialNetworks: [
      {
        name: 'linkedin',
        url: 'https://www.linkedin.com/in/esteban-caiza-a4b1a01a3/',
      },
    ],
  },
  {
    ...
    name: 'Byron Peralta',
    approach: 'Arquitectura sostenible',
    image: `${cdn}/equipo/byron_peralta.webp`,
    rol: 'Miembro fundador',
    alt: 'Miembro del equipo, Byron Peralta',
    education: [
      {
        degree: 'Maestria en Gestión de Proyectos',
        university: 'Universidad San Gregorio de Portoviejo',
      },
      {
        degree: 'Arquitectura y  Urbanismo',
        university: 'Universidad Central del Ecuador',
    ...
    licenceNumber: '2023-001',
    about:
      'Gestor de proyectos en búsqueda constante de mejora en procesos, optimización de recursos y tiempo.',
    socialNetworks: [
      {
        name: 'linkedin',
        url: 'https://www.linkedin.com/in/byron-peralta-a4b1a01a3/',
      },
    ],
  },
];
